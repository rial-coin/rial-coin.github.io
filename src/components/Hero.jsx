...
export const Hero = () => {
  return (
    <section
      className="w-screen flex justify-center items-center bg-gradient-to-b from-primaryColor to-bgDark1 pb-24 sm:pb-32 md:pb-44 lg:pb-56"
      id="home"
    >
      <div className="w-full max-w-6xl flex flex-col justify-center items-center pt-20 md:pt-28 lg:pt-32 text-center">
        ...
        >
          <div className="flex flex-col gap-4 sm:flex-row mt-12">
            <a
              href="/buy"
