  ...
  const handleConnect = async () => {
    if (!userFriendlyAddress) {
      ...
      try {
        ...
        if (error.message?.includes('UnknownError') || error.message?.includes('Reject request')) {
          ...
          setError("Failed to connect wallet. Please ensure you have a TON wallet installed and try again.");
        }
      } finally {
